...
//    private MongoOperations listOps;
...
//        return listOps.findAll(Track.class);
        return listOps.leftPop("list:demo");
    }
//
//    /**
//     *
...
//        List<Track> tracks = listOps.find(new Query(criteria),
//                Track.class);
//        return tracks;
//    }
//
...
//        listOps.insert(track);
        try {
//            listOps.set("mykey", 10, "Hello");
                listOps.leftPush("mykey2" ,"Hello12");
        }catch (Exception e){
            System.out.println(e);
        }
//        listOps.leftPush("list:demo", "10", "value");
//        listOps.leftPush("list:demo", "11", "value1");
    }
